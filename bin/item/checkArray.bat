...
if %weaponarray% == 6 (if %weaponsix% == 1 (set weaponname=Bot Buster && set weapondmg=85 && echo It's a freakin' cannon.) else (set weaponarray=0 && set weaponname=Fists && set weapondmg=0 && echo It appears... it's not there. WHERES MY CANNON? && pause && exit /b))
exit /b
...
set /a randomSickcnce2=%random% * 20 / 32768 + 1
...
if %randomSickcnce% == %randomSickcnce2 echo %enemy% snarls and spits, its sickness poisoning you! && echo. && echo You are now sick! && set healthStatus=Sick
)

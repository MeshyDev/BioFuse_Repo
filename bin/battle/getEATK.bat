...
if %resetSwitch% == 2 if %Eattack% LSS 0 set /a Eattack=1 && echo The enemy was too strong and broke through your defenses, dealing 10000 damage! && set /a currentHP=%currentHP%-10000 && goto megaDMGbypass
